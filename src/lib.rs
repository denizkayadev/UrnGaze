...
#[derive(Debug)]
pub struct UrnGazeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UrnGazeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UrnGaze processing");
    
    let mut processor = UrnGazeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UrnGazeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UrnGazeProcessor::new(false);
